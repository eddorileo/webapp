...
<head>
	...
	if(isset($GLOBALS["content"]["robots"])){
		echo '<meta name="robots" content="'.$GLOBALS["content"]["robots"].'">';
	}
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo template_path(true); ?>/css/onoffswitch.css?stamp=<?php echo $cache_version; ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo template_path(true); ?>/css/bootstrap.min.css?stamp=<?php echo $cache_version; ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo template_path(true); ?>/css/theme.css?stamp=<?php echo $cache_version; ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo template_path(true); ?>/css/common.css?stamp=<?php echo $cache_version; ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo template_path(true); ?>/css/style.css?stamp=<?php echo $cache_version; ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo template_path(true); ?>/css/responsive.css?stamp=<?php echo $cache_version; ?>" />
    ...
    <script>
        ...
        var _rollbarConfig = {
            ...
            payload: {
                environment: window.infringementreport.environment
            }
        };
        // Rollbar Snippet
...
<header id="page-header" class="<?php echo $nav_bar_style; ?>">
    <div class="main">
        <div id="header-main">
    <nav id="primary-menu">
        <span id="menu-toggle" class="icon icon-menu-toggle">
        </span>
