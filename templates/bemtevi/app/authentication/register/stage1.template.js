    ...
    <fieldset>
        <div class="row login-form">
            ...
            <div class="col-sm-8 col-md-8">
                ...
                <label class=" sm left"><input type=checkbox class="form-control" name="marketing-optin"> Eu quero <i>ocasionalmente</i> receber emails sobre atualiza&ccedil;ões do produto, novos campos e novidades (<i>Opcional</i>)</label><BR>
