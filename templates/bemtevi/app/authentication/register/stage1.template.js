    ...
    <fieldset>
        <div class="row login-form">
            ...
            <div class="col-sm-8 col-md-8">
                ...
                <label class=" sm left"><input id="termsagreed" type=checkbox class="form-control" name="termsagreed"> Concordo com os <a href="/terms.php" class="link"> Termos de Serviço Buscalogo</a> e <a href="https://www.iubenda.com/privacy-policy/63177447" class="link iubenda-nostyle no-brand iubenda-embed iub-legal-only" title="Privacy Policy">Privacy Policy</a> <script type="text/javascript">(function (w,d) {var loader = function () {var s = d.createElement("script"), tag = d.getElementsByTagName("script")[0]; s.src="https://cdn.iubenda.com/iubenda.js"; tag.parentNode.insertBefore(s,tag);}; if(w.addEventListener){w.addEventListener("load", loader, false);}else if(w.attachEvent){w.attachEvent("onload", loader);}else{w.onload = loader;}})(window, document);</script> (<i>Required</i>)</label><BR>
                <label class=" sm left"><input type=checkbox class="form-control" name="marketing-optin"> Eu quero <i>ocasionalmente</i> receber emails sobre atualizações so produto, novos campos e novidades (<i>Optional</i>)</label><BR>
