...
<script src="<?php echo template_path(true); ?>/app/ignore/list/main.template.js?cachebuster=<?php echo $cache_version; ?>"></script>
<script src="/app/ignore/list/functions.js?cachebuster=<?php echo $cache_version; ?>"></script>
