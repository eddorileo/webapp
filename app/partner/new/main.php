...
<script src="<?php echo template_path(true); ?>/app/partner/new/main.template.js?cachebuster=<?php echo $cache_version; ?>"></script>
<script src="/app/date.functions.js?cachebuster=<?php echo $cache_version; ?>"></script>
<script src="/app/partner/new/functions.js?cachebuster=<?php echo $cache_version; ?>"></script>
