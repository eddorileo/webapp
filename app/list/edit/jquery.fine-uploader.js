    ...
    qq.FormUploadHandler = function(spec) {
        ...
        qq.extend(this, {
            ...
            _initFormForUpload: function(spec) {
                ...
                form.setAttribute("action", url.replace("[filename]",params.name));
    ...
    qq.traditional.FormUploadHandler = function(options, proxy) {
        ...
        function createForm(id, iframe) {
            ...
            return handler._initFormForUpload({
                method: method,
                endpoint: endpoint.replace("[filename]",name),
                params: params,
    ...
    qq.traditional.XhrUploadHandler = function(spec, proxy) {
        ...
        var handler = this, getName = proxy.getName, getSize = proxy.getSize, getUuid = proxy.getUuid, log = proxy.log, multipart = spec.forceMultipart || spec.paramsInBody, addChunkingSpecificParams = function(id, params, chunkData) {
            ...
            if (!spec.paramsInBody) {
                ...
                endpoint = qq.obj2url(params, endpoint.replace("[filename]",name));
                // ALEC EDITED: add filename to endpoint, don't add query string
            }
